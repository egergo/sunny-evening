...
public class LibVpxEnc extends LibVpxCom {
  ...
  public static final long VPX_EFLAG_FORCE_KF = (1l << 0);
  
  /**
   * Don't reference the last frame. 
   */
  public static final long VP8_EFLAG_NO_REF_LAST = (1l << 16);
  
  /**
   * Don't reference the golden frame. 
   */
  public static final long VP8_EFLAG_NO_REF_GF = (1l << 17);
  
  /**
   * Don't reference the alternate reference frame. 
   */
  public static final long VP8_EFLAG_NO_REF_ARF = (1l << 21);
  
  /**
   * Don't update the last frame. 
   */
  public static final long VP8_EFLAG_NO_UPD_LAST = (1l << 18);
  
  /**
   * Don't update the golden frame. 
   */
  public static final long VP8_EFLAG_NO_UPD_GF = (1l << 22);
  
  /**
   * Don't update the alternate reference frame. 
   */
  public static final long VP8_EFLAG_NO_UPD_ARF = (1l << 23);
  
  /**
   * Force golden frame update. 
   */
  public static final long VP8_EFLAG_FORCE_GF = (1l << 19);
  
  /**
   * Force alternate reference frame update. 
   */
  public static final long VP8_EFLAG_FORCE_ARF = (1l << 24);
  
  /**
   * Disable entropy update. 
   */
  public static final long VP8_EFLAG_NO_UPD_ENTROPY = (1l << 20);
  ...
  public ArrayList<VpxCodecCxPkt> encodeFrame(byte[] frame, int fmt, long frameStart, long frameDuration, long flags, long deadline)
      throws LibVpxException {
    if (!vpxCodecEncode(vpxCodecIface, frame, fmt, frameStart, frameDuration, flags, deadline)) {
