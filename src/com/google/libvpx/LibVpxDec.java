...
public class LibVpxDec extends LibVpxCom {
  ...
  private native int vpxCodecDecDecode(long decoder, byte[] buf, int bufOffset, int bufSize);
  ...
  public byte[] decodeFrameToBuffer(byte[] rawFrame, int offset, int length) throws LibVpxException {
    if (vpxCodecDecDecode(vpxCodecIface, rawFrame, offset, length) != 0) {
